...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioLotteryAtm = (RadioGroup) findViewById(R.id.radioLotteryAtm);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int selectRadioButtonId = radioLotteryAtm.getCheckedRadioButtonId();
                ...
                if (radioButton != null) {
                    ...
                    if (opcao.equals("Lotericas")) {
                        fetchStores("store", "[Loterias,Lotericas]");
                    } else if (opcao.equals("Caixa 24 Horas")) {
                        fetchStores("atm", "[Caixa24Horas,Banco24Horas]");
                    } else {
    ...
    private void fetchStores(String placeType, String businessName) {
         ...
         */
        Call<PlacesPOJO.Root> call = apiService.doPlaces(placeType, latLngString,  businessName, false, "distance", APIClient.GOOGLE_PLACE_API_KEY);
